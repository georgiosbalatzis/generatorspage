document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        ...
        gr: {
            ...
            // Hero section
            'hero-title': 'ΕΜΠΟΡΙΟ ΓΕΝΝΗΤΡΙΩΝ, ΕΝΟΙΚΙΑΣΕΙΣ , SERVICE, ΕΞΟΠΛΙΣΜΟΣ ΓΕΩΤΡΗΣΕΩΝ',
            'hero-subtitle': 'Αξιόπιστες Λύσεις Γεννητριών για την Ελλάδα',
            'hero-description': 'Τροφοδοτούμε επιχειρήσεις και εκδηλώσεις σε όλη την  Ελλάδα.',
